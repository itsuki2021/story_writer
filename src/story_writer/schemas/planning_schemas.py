...
from story_writer.schemas import Character, EventGraph
...
class StoryPlan(BaseModel):
    premise: str = Field(..., description='The original premise of the story')
    event_graph: EventGraph = Field(..., description='The original event graph generated by the Outline Agents.')
    sub_events: List[SubEvent] = Field(
        ...,
        description='Fine-grained narrative units decomposed from high-level Events',
    )
